...
-   여러 종류의 이벤트가 동시에 발생할 수 있으며, 한 종류의 이벤트가 발생하면 다른 이벤트가 발생할 수 없는 상황
-   경쟁 위험을 무시하면 **모집단의 생존 함수**나 **이벤트 발생률**을 **과대 혹은 과소평가** 할 위험이 있음
...
-   생좀 함수란 결국 각 사건 발생 시점에서의 생존 확률을 누적 곱하여 계산한 시간 $t$까지 생존할 확률
